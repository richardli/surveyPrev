...
if(is_html_output()){
  kbl(indicatorList[1:5, c("ID", "Description", "Topic")], align = 'lll',
...
The table below lists the different types of DHS data and their naming conventions in **surveyPrev**. You can find more details on this [website](https://dhsprogram.com/data/dataset-types.cfm).
...
**Step 2**: We can download [IndicatorList.xlsx](https://github.com/DHSProgram/DHS-Indicators-R/blob/main/IndicatorList.xlsx) from [DHS GitHub site](https://github.com/DHSProgram/DHS-Indicators-R), and search the keyword again in the corresponding chapter to find out
