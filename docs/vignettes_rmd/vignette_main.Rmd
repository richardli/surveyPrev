...
```{r, fig.show='hold',fig.dim = c(7, 7),tidy=FALSE, fig.cap="Admin 2 survey weight ratio and 15-49 female population ratio", out.width = "50%", fig.align = 'center'}
...
```{r,fig.show='hold',fig.dim = c(8, 4), tidy = FALSE, fig.cap="Comparing different model estimates at national level"}
