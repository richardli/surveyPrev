...
In the left plot of Figure 3.2, we see the expected shrinkage (attenuation) of the spatial Fay–Herriot posterior mean estimates as compared to the direct estimates. In the right plot we see the reduction in uncertainty which arises from using all of the data in a single Model.


```{r, warning=FALSE,echo=TRUE,fig.show="hold", fig.height = 5, fig.width = 10,fig.cap="Comparing Admin 1 direct estimates and Admin 1 unstratified cluster-level posterior estimates"}
s1 <- scatterPlot(
      res1=res_ad1$res.admin1,
...
In the Figure 3.3, we can see the same broad conclusion, as noted for figure 2 namely, shrinkage of the estimates and a reduction in uncertainty. 
...
```{r, warning=FALSE,echo=FALSE,fig.show="hold", fig.height = 5, fig.width = 10, fig.cap="Comparing Admin 2 Fay–Herriot estimates and Admin 2 unstratified cluster-level estimates"}
s1 <- scatterPlot(
